...
// sizing the main panel of the game
...
// initializes the gate components
	GamePanel() {
		newPaddles();
		newBall();
	...
	// makes a new ball at the start of a game or after someone scores
	public void newBall() {
		random = new Random();
	...
	public void checkCollision() {
		...
		// Score points and reset paddles & ball
		if (ball.x <= 0) {
			score.player2++;
			newPaddles();
			newBall();
